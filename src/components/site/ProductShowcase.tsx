      ...
      <div className="mx-auto max-w-6xl px-5">
        <Reveal>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="section-lead">تخيّل فريقًا عربيًا حقيقيًا يعمل داخل حساباتك: تتناقش مع سِراج، توافق الفريق على الأولويات، وتتابع التقويم والنتائج — كل ذلك من مساحة عمل واضحة تجمع المحادثة، الجدولة، والإنجاز في مكان واحد.</p>
          </div>
        </Reveal>
        <Reveal delay={100}>
